const people = [
  {
    ...
    name: 'For Students',
    job: 'At any Level',
    text: `For students with academic files, the TutorText  provides a powerful tool that can help them to 
  ...
  },
  {
    ...
    name: 'For Workers',
    job: 'For any sector',
    text: `TutorText is a game-changer for workers who want to streamline their document collaboration process 
  ...
  },
  {
    ...
    job: 'expolore more',
    text: `For curious minds, the TutorText provides a unique opportunity to explore and learn about 
  ...
  },
  {
    ...
    text: `For analysts, the TutorText is a powerful tool that can help them to efficiently analyze and interpret 
